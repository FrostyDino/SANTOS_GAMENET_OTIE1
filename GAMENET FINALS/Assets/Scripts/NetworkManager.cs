...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnStartGameButtonClicked()
    {
        ...
        {
            if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("op"))
            {
                PhotonNetwork.LoadLevel("OpenMap");
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("nr"))
            {
                PhotonNetwork.LoadLevel("NormalMap");
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("mz"))
            {
                PhotonNetwork.LoadLevel("MazeMap");
            }
        }
    }
    #endregion
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue("gm", out gameModeName))
        {
            ...
            if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("op"))
            {
                MapTypeText.text = "Map Type: Open";
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("nr"))
            {
                MapTypeText.text = "Map Type: Normal";
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("mz"))
            {
                MapTypeText.text = "Maze";
            }
        }
