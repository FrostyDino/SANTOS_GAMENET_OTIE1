...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public InputField olayersCountInputField;

    [Header("Join Random Room Panel")]
    public GameObject joinRadomRoomPanel;
    ...
    public void OnCreateRoomButtonClicked()
    {
        ...
        roomOptions.MaxPlayers = (byte)int.Parse(olayersCountInputField.text);

        PhotonNetwork.CreateRoom(roomName, roomOptions);
    }

    public void onCancelButoonClicked() 
    {
    ...
    {
        ActivatePanel(joinRadomRoomPanel);
    ...
    public void ActivatePanel(GameObject panelToBeActivated) 
    {
        ...
        joinRadomRoomPanel.SetActive(panelToBeActivated.Equals(joinRadomRoomPanel));
