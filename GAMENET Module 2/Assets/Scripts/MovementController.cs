...
public class MovementController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        float xMovement = joystickInputAxis.x;
        float zMovement = joystickInputAxis.y;
        ...
        float _yRotation = lookInputAxis.x;
        ...
        float _cameraUpDownRotation = lookInputAxis.y * lookSensitivity;
